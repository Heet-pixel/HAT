...
async function bootstrap() {
  ...
  try {
    ...
    currentHOD = {
      ...
      courses: Array.isArray(hod.courses) && hod.courses.length > 0 ? hod.courses : ['General'],
...
function showSection(id) {
  ...
  const navMap = { dashboard: 0, students: 1, teachers: 2, cc: 3, courses: 4, markattendance: 5, schedule: 6, marksupload: 7, reports: 8, announcement: 9, profile: 10, logout: 11 };
